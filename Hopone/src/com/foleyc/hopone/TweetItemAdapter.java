...
import com.foleyc.hopone.TwitterDownloader.Tweet;

//import com.foley.hopscotch.planner.FeedsActivity.Tweet;
//import com.foley.hopscotch.planner.TwitterDownloader.Tweet;
...
public class TweetItemAdapter extends ArrayAdapter<Tweet> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {		
			...
			v = vi.inflate(R.layout.feedslistitem, null);
